 ...
 */
public class GroupKindsAnswerAdapterH extends BaseAdapter {
    private Context context;
    List<String> list=new ArrayList<String>();
    public GroupKindsAnswerAdapterH(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=View.inflate(context,R.layout.item_for_group_kinds_answer,null);
